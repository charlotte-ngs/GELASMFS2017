...
Thema[which(Datum == format(as.Date("2017/05/22"), "%d.%m"))] <- paste0("ZWS Schwein ([slides](",sBaseUrl,"w14/Zuchtwertschätzung Vorlesung ETH Zürich Mai2017.pdf))([ZWS Rind](",sBaseUrl, "w14/Slides_20170522.pdf))" )
### # create the table
